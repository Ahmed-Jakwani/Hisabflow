...
###############################################################################
{
    'name': "Automatic Database Backup To Local Server, Remote Server "
            "(FTP/SFTP), Google Drive and Google Cloud Storage Odoo19",
    'version': '19.0.2.0.2',
    'live_test_url': 'https://youtu.be/Q2yMZyYjuTI',
    'category': 'Extra Tools',
    'summary': """Odoo Database Backup, Automatic Backup, Database Backup,
     Automatic Backup, Database auto-backup, odoo backup google drive,
     google cloud storage, ftp, sftp or remote server, Odoo19, Backup,
     Database, Odoo Apps""",
    ...
    odoo19 automatic database backup, backup google drive, backup google
     cloud storage, backup to a remote server via FTP/SFTP. It also provides
     option to submit support tickets.""",
    ...
    'external_dependencies': {
        'python': ['paramiko', 'google-cloud-storage']},
    'assets': {
        'web.assets_backend': [
