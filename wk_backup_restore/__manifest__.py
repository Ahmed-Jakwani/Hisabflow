...
#################################################################################
{
  ...
  "live_test_url"        :  "http://odoodemo.webkul.in/demo_feedback?module=wk_backup_restore",  
  "depends"              :  [
                              'base',
                              'mail'
                            ],
