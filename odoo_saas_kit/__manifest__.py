...
#################################################################################
{
  ...
  "data"                 :  [
                             ...
                             'views/contract_renew_mail_template.xml',
                             ...
                             'wizards/view_credentials_wizard_view.xml',
  ...
  "assets"               : {
                            'web.assets_frontend': [
                              "/odoo_saas_kit/static/src/js/domain_mapping_page.js",
                              "/odoo_saas_kit/static/src/js/success_redirect_page.js",
